...
if __name__ == "__main__":
    ...
    # output_path = "/ourdisk/hpc/cm3atou/dont_archive/xinwang/alloy2vec-main/alloy2vec/training/1processed_all_1.txt"
    ...
    # path = "/ourdisk/hpc/cm3atou/dont_archive/xinwang/alloy2vec-main/alloy2vec/training/1processed_all_2.txt"
    ...
    sentences, phraser = wordgrams(processed_sentences,
                          ...
                          ip=INCLUDE_PHRASES)
    phraser.save(os.path.join("training/models", args.model_name + "_phraser.pkl"))
    ...
    # load model
    model_path = "/home/etica/Project/tracking_progress_metallic_materials/training/models/model_121520"
    model = Word2Vec.load(model_path)
    # use new sentences (from line 173) to update vocabulary list
    ...
    model.save(os.path.join("training/models", args.model_name))

    analogy_file = os.path.join("data", "analogies.txt")

    # Save the accuracies in the tmp folder.
    compute_epoch_accuracies("training/tmp", args.model_name, analogy_file)
